...
function normalizeMovie(docSnap) {
  ...
  return {
    ...
    backdrop: data.backdropUrl || data.backdrop || data.horizontalPoster || data.landscapePoster || data.bannerUrl || data.banner || "",
    backdropUrl: data.backdropUrl || data.backdrop || data.horizontalPoster || data.landscapePoster || data.bannerUrl || data.banner || "",
